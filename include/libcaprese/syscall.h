...
#define SYS_CAP_SIZE (SYSNS_CAP | 1)
...
#define SYS_TASKCAP_KILL         (SYSNS_TASKCAP | 0)
#define SYS_TASKCAP_SWITCH       (SYSNS_TASKCAP | 1)
#define SYS_TASKCAP_SUSPEND      (SYSNS_TASKCAP | 2)
#define SYS_TASKCAP_RESUME       (SYSNS_TASKCAP | 3)
#define SYS_TASKCAP_GET_REG      (SYSNS_TASKCAP | 4)
#define SYS_TASKCAP_SET_REG      (SYSNS_TASKCAP | 5)
#define SYS_TASKCAP_TRANSFER_CAP (SYSNS_TASKCAP | 6)
